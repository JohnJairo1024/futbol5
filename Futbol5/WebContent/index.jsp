...
<head>
	...
	<link media="screen, all" type="text/css" href="style/master.css" rel="stylesheet" />
	<link media="screen, all" type="text/css" href="style/skeleton.css?ver=3.4.2" rel="stylesheet" />
	<link id="general-css-css" media="all" type="text/css" href="style/style2.css?ver=3.4.2" rel="stylesheet" />
	<link id="prettyPhoto-css-css" media="screen, all" type="text/css" href="style/prettyPhoto.css?ver=3.4.2" rel="stylesheet" />
	<link id="flexslider-css-css" media="screen, all" type="text/css" href="style/flexslider.css?ver=3.4.2" rel="stylesheet" />
	<link id="color-css-css" media="screen, all" type="text/css" href="style/color.css?ver=3.4.2" rel="stylesheet" />

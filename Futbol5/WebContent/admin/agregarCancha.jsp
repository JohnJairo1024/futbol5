                ...
                <div class="maincontent noright">
                        ...
                        <div class="maincontentinner">
                            <div class="content">
                                <div class="contenttitle">
                                    <h2 class="form"><span>Buscar cancha por Nombre:</span></h2>
                                </div>
                                <br>
                                <section id="fetch">
                                    <input style="width: 172px; height: 36px;" type="text" placeholder="Ingrese la Cancha" id="term" />
                                    <form  class="stdform" >

                                        <p class="stdform" style="width: 130px ! important; margin-left: 184px ! important; margin-top: -35px ! important;">
                                        <button class="submit radius2"  id="search" >Buscar Cancha</button></p>
                                    </form>
                                </section>
                                <section id="poster" style="padding-top:20px; height: 130px;"> </section>
                                <form action="procesaAgregaCancha.jsp" method="post" class="stdform" id="form1">
                                    ...
                                    <input id="ubicacion" type="hidden"  name="ubicacion" />
                    ...
                    <div class="content">
                        <div class="maincontentinner">
                            <div class="content">
                                <div class="contenttitle">
                                    <h2 class="form"><span>Ultimas</span></h2>
                                </div>
                                <br>
                                <div id="canchas" style="height: 100%;"></div>
                    ...
                    <div class="content">
                        <div class="maincontentinner">
                            <div class="content">
                                <div class="contenttitle">
                                    <h2 class="form"><span>Agregue una cancha</span></h2>
                                </div>
                                <br>
                                <form action="procesaAgregaCancha.jsp" method="post" class="stdform" id="formCancha">
                                    <p>
                                        <label>Nombre</label>
                                    ...
                                    <p>
                                        ...
                                        <span class="field"><input type="text" class="longinput required" id="ubicacion" name="ubicacion"></span>
                                    </p>
                                    <p>
                                        <label>Video</label>
                                        <span class="field"><input type="text" class="longinput required number" id="idvideo" name="idvideo"></span>
                                    </p>
                    ...
                    if(film == ''){            
                        ...
                        var jqxhr=$.getJSON("http://api.themoviedb.org/2.1/Movie.search/en/json/23afca60ebf72f8d88cdcae2c4f31866/" + film + "?callback=?", function(json) {
                            ...
                            if (json != "Nothing found."){
                                ...
                                $("#nombre").attr("value",limpiarTexto(json[0].name)); $('#guardarfilm').show();
                                ...
                                $.getJSON("http://api.themoviedb.org/3/movie/7555?api_key=23afca60ebf72f8d88cdcae2c4f31866", function(data) {
                                    // $("#ubicacion").attr("value",data.genres);
                                    var items = [];
                                    $.each(data.genres, function(key, val) {
                                        //  items.push('<li id="' + key + '">' + val.name + '</li>');
                                        if (key==0)
                                        {
                                            $("#ubicacion").attr("value",val.name);
                                        }
                                    });
             ...
             $(document).ready(function(){  
                $.getJSON("http://api.themoviedb.org/3/movie/upcoming?api_key=23afca60ebf72f8d88cdcae2c4f31866", function(data) {
                    ...
                    $.each(data.results, function(key, val) {
                        ...
                        items.push('<form class="stdform" id="'+val.id+'"  action="procesaAgregaCancha.jsp" method="post">');
                        items.push('<input type="hidden" name="idvideo" value="'+val.id+'" />');
                        items.push('<input type="hidden" name="nombre" value="'+limpiarTexto(val.title)+'" />');
                    ...
                    $.each(id, function(key, val) {
                        ...
                        $.getJSON("http://api.themoviedb.org/3/movie/"+val+"?api_key=23afca60ebf72f8d88cdcae2c4f31866", function(data3) {
                            ...
                            $.each(data3.genres, function(key, val2) {
                                $("#"+val+"").append('<input type="hidden" name="ubicacion" value="'+limpiarTexto(val2.name)+'" />');

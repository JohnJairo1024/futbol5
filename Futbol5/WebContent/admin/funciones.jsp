...
<%
    ...
    Hashtable ListaFunciones = oDatosEntrada.ListarFunciones();
            ...
            <div class="mainwrapperinner">
              <%@include file="left.jsp" %>
                <div class="maincontent noright">
                    <a href="agregarFunciones.jsp" class="stdform"><button class="submit radius2 ">Agregar una entrada</button></a>                    
                    <div>
                        <tr>
                            <th class="head0">&nbsp;</th>
                        </tr> 
                        ...
                        <div class="maincontentinner">
                            ...
                            <div class="content">
                                <div class="contenttitle radiusbottom0">
                                    <h2 class="table"><span>Lista de Entradas</span></h2>
                                </div><!--contenttitle-->              	

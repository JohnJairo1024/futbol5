<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <script>    
function cargarVideo(idCancha)
{
      $.getJSON("http://api.themoviedb.org/3/movie/"+idCancha+"/trailers?api_key=23afca60ebf72f8d88cdcae2c4f31866", function(json) {
...
<script>
<%
int idCancha=Integer.parseInt(request.getParameter("idvideo"));
out.print("cargarVideo("+idCancha+")");
%>
</script>
    </body>
